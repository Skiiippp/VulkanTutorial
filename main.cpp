...
private:
    ...
    void initVulkan() {
        ...
        createImageViews();
        createRenderPass();
        createDescriptorSetLayout(); //error here
    ...
    void createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
        ...
        imageInfo.extent.width = static_cast<uint32_t>(height);
        imageInfo.extent.height = static_cast<uint32_t>(width);
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load("textures/diamondoretexture.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    //C:\Users\jimmy\Downloads\CSC400JamesGruber\CSC400JamesGruber\shaders
    //$(ProjectDir)
    ...
    void createSwapChain() {
        ...
        uint32_t queFamilyIndices[] = { indices.graphicsFamily.value(), indices.presentFamily.value() };
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        time = 0; //don't want rotation for demo
    ...
    void drawFrame() {
        ...
        updateUniformBuffer(currentFrame); // may have to move this
    ...
    void createInstance() {
        ...
        //code to print avaliable extentions
        /*
